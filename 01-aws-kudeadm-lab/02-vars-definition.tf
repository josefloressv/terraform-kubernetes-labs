...
variable "cluster_control_name" {
  type        = string
  description = "Provides the name of the control plane cluster"
}

variable "cluster_node_prefix_name" {
  type        = string
  description = "Provides the prefix name for each worker node cluster"
}
